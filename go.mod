...
require (
	...
	github.com/filecoin-project/go-state-types v0.14.1-0.20240808054359-b46a7005678f
	github.com/filecoin-project/lotus v1.28.2-0.20240813013322-0b94fee70949
